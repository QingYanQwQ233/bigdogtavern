...
for (const marker of [
  ...
  'function normalizeRpgAgentCommitTrace',
  'function rpgAgentCallsFromTrace',
  '最终输出不得包含 toolCalls',
  'protocolRepairDraft',
  '从已完成检查点恢复，仅重试输出协议',
  'worldTurnPending.agentCalls = rpgAgentCallsFromTrace',
  'anchor.outerHTML = rpgCheckFeedbackMarkup(state)',
