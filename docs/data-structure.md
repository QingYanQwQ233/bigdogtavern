...
| `prefs` | `{formatPreset,formatCustom,stop,wiScanDepth,wiWholeWord,currentPresetByMode,cotEnabled,cotEffort,worldContextBudget}` | 界面偏好默认值；酒馆/RPG 分别记忆当前预设；RPG 世界上下文字符预算 |
